...
public class ItemManager {
	public static final ItemArmor.ArmorMaterial ARMOR_MATERIAL_QUANTUM = EnumHelper.addArmorMaterial("IE:QUANTUM", 100,
			new int[] { 3, 8, 6, 3 }, 20);
	public static final String[] TEXTURE_QUANTUM = { "industrialexpansion:textures/armor/" + "Quantum_1.png",
			"industrialexpansion:textures/armor/" + "Quantum_2.png" };
	// Item List
